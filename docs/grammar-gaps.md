...
Validated Zed-compatible grammar revision: `feec016d131deff48519a7bd5f1309cd7c3ab7ef`.

## Observed gaps

- More complex modern loop type annotations may need follow-up coverage beyond the supported simple forms such as `for value: uint256 in values:`.
